...
Adds ListOps data type support, which required a new data mode (Q/A format instead of just words).

Adds Distance data type support, which is a sequence of ints, and distance to last repetition must be learned

Data input/output layouts described in [README-DATA.md](README-DATA.md)
