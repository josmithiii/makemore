...
python $MAKEMORE --input "$LISTOPS_DATA" --data-mode "qa" --block-size 64 --type gru --max-steps 210 && \
python $MAKEMORE --input "$LISTOPS_DATA" --data-mode "qa" --block-size 64 --type transformer --max-steps 210 && \
